...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [115354.511838, 605342.411549, 115765.753104, 605585.782021], maxZoom: 28, minZoom: 18, projection: new ol.proj.Projection({
            code: 'EPSG:23836',
            //extent: [114190.937600, 604123.060200, 116767.904100, 605889.470600],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([115354.511838, 605342.411549, 115765.753104, 605585.782021], map.getSize());
